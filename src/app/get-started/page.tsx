...
import { User, Mail, Phone, Briefcase, Star, Instagram, Linkedin, Facebook, CheckCircle2, ChevronRight, ChevronLeft, CreditCard } from 'lucide-react';
...
export default function OnboardingPage() {
    ...
    return (
        <main className="min-h-screen py-20 px-6 bg-background">
            <div className={`mx-auto transition-all duration-500 ${step === 1 ? 'max-w-5xl' : 'max-w-2xl'}`}>
                {/* Progress Bar */}
